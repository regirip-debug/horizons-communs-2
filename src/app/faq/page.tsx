...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Oui, mes formations peuvent être prises en charge par les OPCO (notamment Uniformation pour le secteur de l'ESS). Je vous accompagne dans les démarches administratives de demande de financement si nécessaire.",
  },
  {
